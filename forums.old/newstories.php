...
echo("<table border=0 cellpadding=1 cellspacing=$cs $twt><tr bgcolor=\"$hc\">\n");
if ($showicon == "1") {
	echo("<td>&nbsp;</td>");
}
echo("<td style=\"font-family:$f; font-size:$hfs; color:$tc;\"><b><nobr><font color=black><b>Newest stories</font></b></nobr></b></td>\n");
// the last poster column,
if ($lastposter == "1") {
	echo("<td style=\"font-family:$f; font-size:$hfs; color:$tc;\" align=\"left\"><b><nobr>Author</nobr></b></td>\n");
}
...
while ($threads = mysql_fetch_array($tr)) {	
	...
	echo("<a href=\"$url/showthread.php?threadid=$threads[threadid]\" title=\"$threads[title]\">$title</a></nobr></td>\n");
	// last poster column?
	if ($lastposter == "1") {
		echo("<td bgcolor=\"$bc\" style=\"font-family:$f; font-size:$fs; color:$tc;\" align=\"left\"><a href=\"$url/member.php?action=getinfo&userid=$threads[userid]\" style=\"font-family:$f; font-size:$fs; color:$tc;\">$threads[lastposter]</a></td>\n");
		++$cols;
	}
	// the last post date & time column,
	if ($lastpostdate == "1") {
