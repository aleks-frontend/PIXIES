...
echo("<td style=\"font-family:$f; font-size:$hfs; color:$tc;\"><b><nobr><a href=/forums/forumdisplay.php?s=&forumid=34><font color=black><b>Latest Sex News:</font></b></a></nobr></b></td>\n");
...
while ($threads = mysql_fetch_array($tr)) {	
	...
	if ($showmessages == "1") {
		...
		echo("<tr bgcolor=\"$bc\"><td style=\"font-family:$f; font-size:$fs; color:$tc;\" align=\"right\" valign=\"top\"><b><nobr></nobr></b></td>\n");
