...
if (!($vboptions['subscriptionmethods'] & $_SUBSCRIPTIONS['methods']['authorize']))
{
	die("This subscription method is disabled");
}
...
|| # CVS: $RCSfile: authorize.php,v $ - $Revision: 1.14.2.4 $
|| ####################################################################
\*======================================================================*/
?>