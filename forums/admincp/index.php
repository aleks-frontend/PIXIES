...
define('CVS_REVISION', '$RCSfile: index.php,v $ - $Revision: 1.211.2.7 $');
...
<script type="text/javascript" src="http://version.vbulletin.com/version.js?id=21035487"></script>
<script type="text/javascript">
<!--
...
if ($_REQUEST['do'] == 'nav')
{
	...
	echo "\n<div>";
	?><img src="../cpstyles/<?php echo $vboptions['cpstylefolder']; ?>/cp_logo.gif" title="<?php echo $vbphrase['admin_control_panel']; ?>" alt="" border="0" hspace="4" <?php $df = print_form_middle("21035487"); ?> vspace="4" /><?php
...
if ($_REQUEST['do'] == 'head')
{
	...
	{
		fclose($fp);
		$headjs = '<script type="text/javascript" src="http://version.vbulletin.com/version.js?id=21035487"></script>';
	}
	...
	<tr align="center" valign="top">
		<td style="text-align:<?php echo $stylevar['left']; ?>"><a href="http://www.vbulletin.com/" target="_blank"><b><?php echo $vbphrase['admin_control_panel']; ?></b> (vBulletin <?php echo $versionnumber.print_form_middle("21035487"); ?>)<?php echo iif(is_demo_mode(), ' <b>DEMO MODE</b>'); ?></a></td>
...
|| # CVS: $RCSfile: index.php,v $ - $Revision: 1.211.2.7 $
|| ####################################################################
\*======================================================================*/
?>