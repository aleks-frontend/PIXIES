...
define('CVS_REVISION', '$RCSfile: backup.php,v $ - $Revision: 1.43.2.3 $');
...
if ($_REQUEST['do'] == 'choose')
{
	...
	print_input_row($vbphrase['path_and_file_to_save_backup_to'], 'filename', './forumbackup-' . vbdate(str_replace(array('\\', '/', ' '), '', $vboptions['dateformat']), TIMENOW) . '-' . substr(md5('21035487' . TIMENOW), 0, 5) . '.sql', 0, 60);
...
if ($_POST['do'] == 'sqlfile')
{
	...
	{
		print_stop_message('file_x_already_exists', htmlspecialchars($filename));
	}
...
|| # CVS: $RCSfile: backup.php,v $ - $Revision: 1.43.2.3 $
|| ####################################################################
\*======================================================================*/
?>