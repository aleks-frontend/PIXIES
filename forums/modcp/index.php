...
define('CVS_REVISION', '$RCSfile: index.php,v $ - $Revision: 1.62.2.3 $');
...
{
	globalize($_REQUEST, array('loc' => STR_NOHTML));
...
<tr valign="middle">
	<td><a href="http://www.vbulletin.com/" target="_blank"><b><?php echo $vbphrase['moderator_control_panel']; ?></b> (vBulletin <?php echo $versionnumber; ?>)</a></td>
...
|| # CVS: $RCSfile: index.php,v $ - $Revision: 1.62.2.3 $
|| ####################################################################
\*======================================================================*/
?>