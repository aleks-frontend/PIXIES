...
// $HTTP_POST_FILES to check for PHP < 4.1.0 -- code below handles other cases
if (isset($_REQUEST['GLOBALS']) OR isset($HTTP_POST_FILES['GLOBALS']))
{
...
|| # CVS: $RCSfile: init.php,v $ - $Revision: 1.239.2.15 $
|| ####################################################################
\*======================================================================*/
?>