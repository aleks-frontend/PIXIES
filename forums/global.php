...
$show['contactus'] = iif($vboptions['contactuslink'] AND ((!$bbuserinfo['userid'] AND $vboptions['contactustype']) OR ($bbuserinfo['userid'])), true, false);
...
|| # CVS: $RCSfile: global.php,v $ - $Revision: 1.256.2.7 $
|| ####################################################################
\*======================================================================*/
?>
