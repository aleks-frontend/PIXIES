...
$len = 125; // maximum number of characters of the title to show. e.g. if the title is 60 characters and this is set to 25, only the first 25 characters of the title will be shown (followed by ...)
...
$includeforums = "34"; // if you only want to include certain forums, put their ids here. separate more than one with commas, NO SPACES! e.g. 1,2,3,4
$showmessages = "0"; // show the text of the last post too? 1 = yes; 0 = no
$lplen = "200"; // character length of last post text (if $showmessages is set to 0 this won't do anything).
...
$cs = "2"; // this is the cellspacing. 1 makes a thin line around the cells. 0 makes no line.
