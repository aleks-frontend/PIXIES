...
# http part, ie, "http://www.pixies-place.com/cgi-bin/recommend.cgi";
#
...
#   @okaydomains=("http://pixies-place.com", "http://www.pixies-place.com", "http://pixies-place.net", "http://www.pixies-place.net");

   $SCRIPT_NAME="http://www.pixies-place.com/cgi-bin/recommend.cgi";
   $SITE_NAME="Pixies Free Erotic Stories";
   $SITE_URL="http://www.pixies-place.com/";
   $ENDLINE="";
   $MAXNUM=5;
   $LOGFILE="reflog.txt";
...
<CENTER>
<P>                                                               
<TABLE WIDTH=550 BGCOLOR="ffcc00">
 <TR>
 <TD>
