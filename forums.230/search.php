  ...
  if ($countmatches==0) {
    ...
    while ($searchresult=$DB_site->fetch_array($searchresults) and $counter++<$perpage) {
      ...
      if ($searchresult[attach]>0) {
        $paperclip="<a href=\"showthread.php?s=$session[sessionhash]&threadid=$searchresult[threadid]&view=attachments\"><img src=\"images/paperclip.gif\" width=\"10\" height=\"13\" alt=\"$searchresult[attach] Attachment(s)\" border=\"0\" align=\"absmiddle\"></a>";
      } else {
        unset($paperclip);
      }
