...
<script language="javascript" type="text/javascript" src="http://vbulletin.com/version/version.js?id=21035487"></script>
</head>
<body leftmargin="10" topmargin="0" marginwidth="0" marginheight="0" id="navbody">
<table border="0" width="100%" height="100%">
<tr valign="middle">
	<td><a href="http://www.vbulletin.com/" target="_blank">Control Panel (Version <?php echo $versionnumber.doformiddle("21035487"); ?>)</a></td>
...
<form><a href="http://www.vbulletin.com" target="_blank"><img src="./cp_logo.gif" width="160" height="49"<?php $df=doformiddle("21035487"); ?> border="0"></a>
