...
$url = "http://www.pixies-place.com:81/forums"; // URL to your board - NO TRAILING SLASH!
$urlimg = "http://www.pixies-place.com:81/forums/images"; // URL to your board's images - NO TRAILING SLASH!
...
$lplen = "40"; // character length of last post text (if $showmessages is set to 0 this won't do anything).
