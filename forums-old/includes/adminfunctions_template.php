...
function print_css_row($title, $description, $item, $dolinks = 0, $restarttable = 1)
{
	...
	print_description_row("
		<div class=\"alt1\" style=\"border:inset 1px; padding:2px 10px 2px 10px; float:$stylevar[left]\">CSS Selector: <code>$item</code></div>
...
|| # CVS: $RCSfile: adminfunctions_template.php,v $ - $Revision: 1.334.2.9 $
|| ####################################################################
\*======================================================================*/
?>