...
define('CVS_REVISION', '$RCSfile: misc.php,v $ - $Revision: 1.134.2.3 $');
...
if ($_REQUEST['do'] == 'buildpostcache')
{
	...
	while ($post = $DB_site->fetch_array($posts))
	{
		...
		$saveparsed .= ", ($post[postid]," . intval($post['lastpost']) . ',' . contains_bbcode_img_tags($parsed_postcache['new']) . ',\'' . addslashes($parsed_postcache['new']) . '\')';
...
|| # CVS: $RCSfile: misc.php,v $ - $Revision: 1.134.2.3 $
|| ####################################################################
\*======================================================================*/
?>