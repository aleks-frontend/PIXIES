...
<script language="JavaScript" src="controls.js"></script>
  ...
  <table width="100%" height="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="f1f1f1"><form name="jform">  
    <tr bgcolor="#CCCCCC"> 
...
?>
    ...
    <tr> 
      <td width="1" align="center" valign="top" bgcolor="#CCCCCC"> <a href="javascript:document.jchat.processJInput(':)');"><img src="gfx/smile.gif" border=0 alt="happy" vspace="2" hspace="0"></a><br> 
      ...
      <td width="99%" valign="top" height="99%"> <applet name="jchat" archive="jirc_nss.zip"  code=Chat.class width=100% height=100% vspace="1" hspace="1" >
    ...
    <tr align="center" valign="top" bgcolor="ffcc00"> 
      <td height="1" colspan="2"> <div align="left"> </div>
        <table border="0" cellspacing="0" cellpadding="0" bordercolor="<?echo $bcolor;?>">
          <tr> 
            <td><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Nickserv</font></td>
            <td><font size="2" face="Arial, Helvetica, sans-serif">Chanserv/botserv</font></td>
            <td><font size="2" face="Arial, Helvetica, sans-serif">Ops</font></td>
          </tr>
          <tr> 
