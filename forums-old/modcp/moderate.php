...
define('CVS_REVISION', '$RCSfile: moderate.php,v $ - $Revision: 1.64.2.1 $');
...
if ($_REQUEST['do'] == 'events')
{
	...
	else
	{
		...
		{
			if (can_moderate_calendar($calendar['calendarid'], 'canmoderateevent'))
			{
...
|| # CVS: $RCSfile: moderate.php,v $ - $Revision: 1.64.2.1 $
|| ####################################################################
\*======================================================================*/
?>