...
############################################################################
   ...
   if ($threadid <= 0) {
      print "<A HREF=\"$forumpath/newthread.php?s=&action=newthread&forumid=$forum&subject=$topic\">Give feedback about this story!</A>";
   } else {
     print ("<A HREF=\"$forumpath/showthread.php?s=&threadid=$threadid\">Give feedback and discus this story!</A>");
   }
