...
############################################################################
   ...
   if ($threadid <= 0) {
      print "<A HREF=\"$forumpath/newthread.php?s=&action=newthread&forumid=$forum&subject=$topic\">Start the feedback about this story!</A>";
   } else {
     print ("<A HREF=\"$forumpath/showthread.php?s=&threadid=$threadid\">Read the feedback about this story!</A> or <A HREF=\"$forumpath/newreply.php?s=&action=newreply&threadid=$threadid\">Post your own feedback</A>");
   }
